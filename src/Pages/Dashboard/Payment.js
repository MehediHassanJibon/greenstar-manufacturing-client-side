...
const stripePromise = loadStripe('pk_test_51L4VFpAfPVyCxHp6Jb17wjSyBc53yqPIG6lw7rU3PkYEiy8588xHvSzwiSJJVl2yfBMh1JxTIc3ccvSgg5Dkh1rx00weubV5C2');
...
const Payment = () => {
    ...
    useEffect(() => {
        fetch(`https://floating-badlands-03455.herokuapp.com/payment/${id}`)
            .then(res => res.json())
            .then(data => {
                // console.log(order)
                setOrder(data);
